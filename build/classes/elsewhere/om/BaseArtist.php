...
abstract class BaseArtist extends BaseObject implements Persistent
{
    ...
    public function setPseudo($v)
    {
        ...
        if ($this->pseudo !== $v) {
            $this->pseudo = $v;
            $this->modifiedColumns[] = ArtistPeer::PSEUDO;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = ArtistPeer::STATUT;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ArtistPeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->statut = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArtistPeer::PSEUDO)) {
            $modifiedColumns[':p' . $index++]  = 'pseudo';
        }
        if ($this->isColumnModified(ArtistPeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = 'statut';
        }
        if ($this->isColumnModified(ArtistPeer::DESCRIPTION)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setStatut($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtistPeer::PSEUDO)) $criteria->add(ArtistPeer::PSEUDO, $this->pseudo);
        if ($this->isColumnModified(ArtistPeer::STATUT)) $criteria->add(ArtistPeer::STATUT, $this->statut);
        if ($this->isColumnModified(ArtistPeer::DESCRIPTION)) $criteria->add(ArtistPeer::DESCRIPTION, $this->description);
     ...
     * @return PropelObjectCollection|Work[] List of Work objects
     */
    public function getWorksJoinCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = WorkQuery::create(null, $criteria);
