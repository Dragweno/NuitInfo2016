...
abstract class BaseArtistPeer
{
    ...
    const PSEUDO = 'artist.pseudo';

    /** the column name for the statut field */
    const STATUT = 'artist.statut';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Pseudo', 'Statut', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'pseudo', 'statut', 'description', ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ID, ArtistPeer::PSEUDO, ArtistPeer::STATUT, ArtistPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PSEUDO', 'STATUT', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'pseudo', 'statut', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Pseudo' => 1, 'Statut' => 2, 'Description' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'pseudo' => 1, 'statut' => 2, 'description' => 3, ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ID => 0, ArtistPeer::PSEUDO => 1, ArtistPeer::STATUT => 2, ArtistPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PSEUDO' => 1, 'STATUT' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'pseudo' => 1, 'statut' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArtistPeer::PSEUDO);
            $criteria->addSelectColumn(ArtistPeer::STATUT);
            $criteria->addSelectColumn(ArtistPeer::DESCRIPTION);
        } else {
