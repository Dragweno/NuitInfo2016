...
/**
 * Base class that represents a row from the 'order_work_byid' table.
 *
 *
 *
 * @package    propel.generator.elsewhere.om
 */
abstract class BaseOrderWorkByid extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OrderWorkByidPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrderWorkByidPeer
     */
     ...
     * @return OrderWorkByid The current object (for fluent API support)
     */
    public function setHistoryId($v)
    {
        ...
        if ($this->history_id !== $v) {
            $this->history_id = $v;
            $this->modifiedColumns[] = OrderWorkByidPeer::HISTORY_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = OrderWorkByidPeer::WORK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = OrderWorkByidPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrderWorkByid object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrderWorkByidPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrderWorkByidQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderWorkByidPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrderWorkByidPeer::HISTORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'history_id';
        }
        if ($this->isColumnModified(OrderWorkByidPeer::WORK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'work_id';
        }

        $sql = sprintf(
            'INSERT INTO order_work_byid (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrderWorkByidPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrderWorkByidPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrderWorkByid'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrderWorkByid'][serialize($this->getPrimaryKey())] = true;
        $keys = OrderWorkByidPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderWorkByidPeer::HISTORY_ID)) $criteria->add(OrderWorkByidPeer::HISTORY_ID, $this->history_id);
        if ($this->isColumnModified(OrderWorkByidPeer::WORK_ID)) $criteria->add(OrderWorkByidPeer::WORK_ID, $this->work_id);
    ...
    {
        $criteria = new Criteria(OrderWorkByidPeer::DATABASE_NAME);
        $criteria->add(OrderWorkByidPeer::HISTORY_ID, $this->history_id);
        $criteria->add(OrderWorkByidPeer::WORK_ID, $this->work_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getHistoryId()) && (null === $this->getWorkId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrderWorkByid (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrderWorkByid Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrderWorkByidPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrderWorkByidPeer();
        }
    ...
    public function getHistory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aHistory === null && ($this->history_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aHistory->addOrderWorkByids($this);
             */
        }
    ...
    public function getWork(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aWork === null && ($this->work_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWork->addOrderWorkByids($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrderWorkByidPeer::DEFAULT_STRING_FORMAT);
    }
