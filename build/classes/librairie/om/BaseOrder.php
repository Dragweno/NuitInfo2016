...
abstract class BaseOrder extends BaseObject implements Persistent
{
    ...
    public function setTotalPrice($v)
    {
        ...
        if ($this->total_price !== $v) {
            $this->total_price = $v;
            $this->modifiedColumns[] = OrderPeer::TOTAL_PRICE;
        }
    ...
    public function setNbWork($v)
    {
        ...
        if ($this->nb_work !== $v) {
            $this->nb_work = $v;
            $this->modifiedColumns[] = OrderPeer::NB_WORK;
        }
    ...
    public function setDatePayement($v)
    {
        ...
        if ($this->date_payement !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrderPeer::DATE_PAYEMENT;
            }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = OrderPeer::WORK_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrderPeer::TOTAL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'total_price';
        }
        if ($this->isColumnModified(OrderPeer::NB_WORK)) {
            $modifiedColumns[':p' . $index++]  = 'Nb_Work';
        }
        if ($this->isColumnModified(OrderPeer::DATE_PAYEMENT)) {
            $modifiedColumns[':p' . $index++]  = 'date_Payement';
        }
        if ($this->isColumnModified(OrderPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(OrderPeer::WORK_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderPeer::TOTAL_PRICE)) $criteria->add(OrderPeer::TOTAL_PRICE, $this->total_price);
        if ($this->isColumnModified(OrderPeer::NB_WORK)) $criteria->add(OrderPeer::NB_WORK, $this->nb_work);
        if ($this->isColumnModified(OrderPeer::DATE_PAYEMENT)) $criteria->add(OrderPeer::DATE_PAYEMENT, $this->date_payement);
        if ($this->isColumnModified(OrderPeer::USER_ID)) $criteria->add(OrderPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(OrderPeer::WORK_ID)) $criteria->add(OrderPeer::WORK_ID, $this->work_id);
