...
abstract class BaseOrderPeer
{
    ...
    const NB_WORK = 'order.Nb_Work';

    /** the column name for the date_Payement field */
    const DATE_PAYEMENT = 'order.date_Payement';

    /** the column name for the user_id field */
    const USER_ID = 'order.user_id';

    /** the column name for the work_id field */
    const WORK_ID = 'order.work_id';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (OrderPeer::ID, OrderPeer::TOTAL_PRICE, OrderPeer::NB_WORK, OrderPeer::DATE_PAYEMENT, OrderPeer::USER_ID, OrderPeer::WORK_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (OrderPeer::ID => 0, OrderPeer::TOTAL_PRICE => 1, OrderPeer::NB_WORK => 2, OrderPeer::DATE_PAYEMENT => 3, OrderPeer::USER_ID => 4, OrderPeer::WORK_ID => 5, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderPeer::TOTAL_PRICE);
            $criteria->addSelectColumn(OrderPeer::NB_WORK);
            $criteria->addSelectColumn(OrderPeer::DATE_PAYEMENT);
            $criteria->addSelectColumn(OrderPeer::USER_ID);
            $criteria->addSelectColumn(OrderPeer::WORK_ID);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinWork(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::WORK_ID, WorkPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Order objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Order) to $obj2 (User)
                $obj2->addOrder($obj1);
    ...
    /**
     * Selects a collection of Order objects pre-filled with their Work objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Order objects.
    ...
    public static function doSelectJoinWork(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Order) to $obj2 (Work)
                $obj2->addOrder($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (User)
                $obj2->addOrder($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Order) to the collection in $obj3 (Work)
                $obj3->addOrder($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Order objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = OrderPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (Work)
                $obj2->addOrder($obj1);
    ...
    /**
     * Selects a collection of Order objects pre-filled with all related objects except Work.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
