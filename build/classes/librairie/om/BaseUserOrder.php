...
/**
 * Base class that represents a row from the 'user_order' table.
 *
 *
 *
 * @package    propel.generator.librairie.om
 */
abstract class BaseUserOrder extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserOrderPeer';
     ...
     * @return UserOrder The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UserOrderPeer::ID;
        }
    ...
    public function setTotalPrice($v)
    {
        ...
        if ($this->total_price !== $v) {
            $this->total_price = $v;
            $this->modifiedColumns[] = UserOrderPeer::TOTAL_PRICE;
        }
    ...
    public function setNbWork($v)
    {
        ...
        if ($this->nb_work !== $v) {
            $this->nb_work = $v;
            $this->modifiedColumns[] = UserOrderPeer::NB_WORK;
        }
    ...
    public function setDatePayement($v)
    {
        ...
        if ($this->date_payement !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserOrderPeer::DATE_PAYEMENT;
            }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserOrderPeer::USER_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = UserOrderPeer::WORK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = UserOrderPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserOrder object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserOrderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserOrderQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserOrderPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserOrderPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UserOrderPeer::TOTAL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'total_price';
        }
        if ($this->isColumnModified(UserOrderPeer::NB_WORK)) {
            $modifiedColumns[':p' . $index++]  = 'Nb_Work';
        }
        if ($this->isColumnModified(UserOrderPeer::DATE_PAYEMENT)) {
            $modifiedColumns[':p' . $index++]  = 'date_Payement';
        }
        if ($this->isColumnModified(UserOrderPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(UserOrderPeer::WORK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'work_id';
        }

        $sql = sprintf(
            'INSERT INTO user_order (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserOrderPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserOrderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserOrder'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserOrder'][$this->getPrimaryKey()] = true;
        $keys = UserOrderPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserOrderPeer::ID)) $criteria->add(UserOrderPeer::ID, $this->id);
        if ($this->isColumnModified(UserOrderPeer::TOTAL_PRICE)) $criteria->add(UserOrderPeer::TOTAL_PRICE, $this->total_price);
        if ($this->isColumnModified(UserOrderPeer::NB_WORK)) $criteria->add(UserOrderPeer::NB_WORK, $this->nb_work);
        if ($this->isColumnModified(UserOrderPeer::DATE_PAYEMENT)) $criteria->add(UserOrderPeer::DATE_PAYEMENT, $this->date_payement);
        if ($this->isColumnModified(UserOrderPeer::USER_ID)) $criteria->add(UserOrderPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserOrderPeer::WORK_ID)) $criteria->add(UserOrderPeer::WORK_ID, $this->work_id);
    ...
    {
        $criteria = new Criteria(UserOrderPeer::DATABASE_NAME);
        $criteria->add(UserOrderPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserOrder (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserOrder Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserOrderPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserOrderPeer();
        }
    ...
    {
        return (string) $this->exportTo(UserOrderPeer::DEFAULT_STRING_FORMAT);
    }
